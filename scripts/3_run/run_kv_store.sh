...
# Objective: Run the LMCache KV-block-store arm (lmcache_rag via vLLM's KV-connector) behind live import/health pairing gates
# Cloud:     both
# =============================================================================
...
# (docs/VLLM_COMPATIBILITY.md sec 0) and the LMCache<->0.19.1 pairing has NOT been

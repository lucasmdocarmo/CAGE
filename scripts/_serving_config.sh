...
# =============================================================================
# Sourced by EVERY baseline-tree driver -- run_phase1.sh (core 9 baselines),
...
# FAIR. Consumed by scripts/manage_vllm_server.sh, which reads these env vars when it
# launches vLLM.
#
...
#                        VLLM_GPU_MEMORY_UTILIZATION=$p bash scripts/cloud_run.sh ...; done
...
#   VLLM_ENFORCE_EAGER=1 bash scripts/run_speculative_matrix.sh <model>

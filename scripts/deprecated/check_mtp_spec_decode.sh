...
# per the publication charter §7.5 (MyDocs/PUBLICATION.md). Only consumer is the
# equally-deprecated run_speculative_matrix.sh. See scripts/deprecated/README.md.
# =============================================================================
